...
int check_one;//aggiunto controllo uno
int check_two;//aggiunto controllo due
...

{
	...
	menu ();
	label: // aggiunto label con il goto per reincominciare questa parte di codice in caso dovesse andare in default 
